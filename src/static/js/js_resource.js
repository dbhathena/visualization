...
const unitsDaily = {
    ...
    "Activity Level": (common_unit = "Activity Level (mg)"),
    "Time in Activity Levels": (common_unit = "Hours of Activity"),
    "Light Activity": (common_unit = "Total Minutes in Light Activity"),
    "Moderate Activity": (common_unit = "Total Minutes in Moderate Activity"),
    "Sedentary Activity": (common_unit = "Total Minutes in Sedentary Activity"),
    "Vigorous Activity": (common_unit = "Total Minutes in Vigorous Activity"),
...
const unitsHourly = {
    "Accelerometer": (common_unit = "Vector Magnitude of Motion"),
    "Activity Level": (common_unit = "Activity Level (mg)"),
    "Time in Activity Levels": (common_unit = "Average Minutes of Activity"),
    "Light Activity": (common_unit = "Average Minutes in Light Activity"),
    "Moderate Activity": (common_unit = "Average Minutes in Moderate Activity"),
    "Sedentary Activity": (common_unit = "Average Minutes in Sedentary Activity"),
    "Vigorous Activity": (common_unit = "Average Minutes in Vigorous Activity"),
    "Heart Rate": (common_unit = "BPM"),
...
const titleForTypeDaily = {
    ...
    "Activity Level": "Activity Level Across Study",
    "Time in Activity Levels": "Total Hours of Activity Per Day in Study",
    "Light Activity": "Total Minutes in Light Activity Per Day Over Study",
    "Moderate Activity": "Total Minutes in Moderate Activity Per Day Over Study",
    "Sedentary Activity": "Total Minutes in Sedentary Activity Per Day Over Study",
    "Vigorous Activity": "Total Minutes in Vigorous Activity Per Day Over Study",
...
const titleForTypeHourly = {
    "Accelerometer": "Acceleration",
    "Heart Rate": "Heart Rate",
    "Activity Level": "Average Activity Level by Hour Per Day",
    "Time in Activity Levels": "Average Minutes in Each Activity Level by Hour Of Day",
    "Light Activity": "Average Minutes in Light Activity by Hour Per Day",
    "Moderate Activity": "Average Minutes in Moderate Activity by Hour Per Day",
    "Sedentary Activity": "Average Minutes in Sedentary Activity by Hour Per Day",
    "Vigorous Activity": "Average Minutes in Vigorous Activity by Hour Per Day",
    "Motion": "Motion",
    "Temperature": "Temperature",
    "EDA Mean Difference": "EDA: Mean Difference",
    "EDA Mean": "EDA: Mean",

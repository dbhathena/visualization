...
function drawStudyTrendsIndividual() {
    $.ajax({
        ...
        if (type == "Temperature") {
            ...
            const dates_left = ['x'];
            const dates_right = ['x'];
            const measurements_left = [name];
            const measurements_right = [name];
            ...
            subject_data_left["measurements"].forEach(function(d) {
                measurements_left.push(d);
            });
            subject_data_right["measurements"].forEach(function(d) {
                measurements_right.push(d);
            });
